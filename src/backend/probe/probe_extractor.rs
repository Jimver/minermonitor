...
impl From<AntS9Probe> for AntS9 {
    fn from(probe: AntS9Probe) -> Self {
        ...
        AntS9 {
            ...
            frequency: vec![
                stats.freq_avg_6.unwrap(),
                stats.freq_avg_7.unwrap(),
                stats.freq_avg_8.unwrap(),
            ],
            voltage: vec![
                stats.voltage_6.unwrap(),
                stats.voltage_7.unwrap(),
                stats.voltage_8.unwrap(),
            ],
            error_rate: vec![
                probe.devs[0]._devs[0].hardware_errors,
                probe.devs[0]._devs[1].hardware_errors,
                probe.devs[0]._devs[2].hardware_errors,
            ],
            ...
            temperature2: vec![
                stats.temp_2_6.unwrap(),
                stats.temp_2_7.unwrap(),
                stats.temp_2_8.unwrap(),
            ],
        }
    }
}
